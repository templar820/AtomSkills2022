...
class ExampleController extends Controller implements ASController<IExample>{
  ...
  @Get('{id}')
  public async getOne(id: number): Promise<ASController<IExample>> {
  ...
  @Post()
  public async create(@Body() body: IExample): Promise<ASController<IExample>> {
    const answer = this.service.create(body as IExample);
    return answer;
  }

  @Patch()
  public async update(@Body() body: IExample): Promise<ASController<IExample>> {
    const answer = this.service.update(body as IExample);
    return answer;
  }

  @Delete('{id}')
  public async delete(@Body() body: IExample): Promise<ASController<IExample>> {
